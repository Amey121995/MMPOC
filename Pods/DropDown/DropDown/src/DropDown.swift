...
public class DropDownItem
{
    ...
    public required init(name: String, image: UIImage) {
        self.itemName = name
...
public final class DropDown: UIView {
    ...
    */
    ...
    @objc public dynamic var tblSeparatorStyle = DPDConstant.UI.SeparatorStyle {
        willSet {
            tableView.separatorStyle = newValue
        }
        didSet { reloadAllComponents() }
    }
    @objc public dynamic func setupTableViewSeparatorStyle(_ style: UITableViewCell.SeparatorStyle) {
        tableView.separatorStyle = style
        tblSeparatorStyle = style
        reloadAllComponents()
    }
    ...
    */
    ...
    public var customDataSource = [DropDownItem]() {
        didSet {
            deselectRows(at: selectedRowIndices)
            reloadAllComponents()
        }
    ...
    */
    ...
    public var localizationKeysCustomDataSource = [DropDownItem]() {
        didSet {
    ...
    */
    ...
    public convenience init(anchorView: AnchorView, selectionAction: SelectionClosure? = nil, dataSource: [DropDownItem] = [], topOffset: CGPoint? = nil, bottomOffset: CGPoint? = nil, cellConfiguration: ConfigurationClosure? = nil, cancelAction: Closure? = nil) {
        self.init(frame: .zero)
...
private extension DropDown {
    ...
    func setupUI() {
        ...
        tableView.separatorStyle = tblSeparatorStyle
